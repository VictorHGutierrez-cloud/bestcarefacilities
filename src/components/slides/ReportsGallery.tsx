...
function ReportCard({
  ...
  return (
    <button
      onClick={onClick}
      className="group border border-foreground/20 bg-background overflow-hidden text-left hover:border-foreground/40 hover:shadow-xl transition-all duration-300"
    >
